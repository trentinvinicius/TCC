...
private:
    osg::ref_ptr< ood::Manager >             m_manager ;
    osg::ref_ptr< ood::DifferentialJoint >   m_differential ;
    osg::ref_ptr< ood::Joint >               m_left_slider ;
    osg::ref_ptr< ood::Joint >               m_right_slider ;
} ;
...
Scene::init(int argc, char** argv)
{
     ...
     * [2] create the joint
     */
    ood::DifferentialJoint*  j = new ood::DifferentialJoint() ;
     ...
     */
    osg::ref_ptr<ood::Collidable>    wheel = dynamic_cast<ood::Collidable*>( osgDB::readObjectFile("car_wheel.osgt") ) ;
    ...
    ood::RigidBody*  b1 = osg::clone( wheel.get() ) ;
    ood::RigidBody*  b2 = osg::clone( wheel.get() ) ;
    ...
    {
        osg::ref_ptr<ood::Collidable>    cube = dynamic_cast<ood::Collidable*>( osgDB::readObjectFile( "woodenbox1.osgt" ) ) ;
        ...
        ood::RigidBody*  up_left = osg::clone( cube.get() ) ;
        ood::RigidBody*  up_right = osg::clone( cube.get() ) ;
        ...
        osg::ref_ptr<ood::Joint> slider = new ood::SliderJoint() ;
        ...
        osg::ref_ptr<ood::RigidBody> down_left = osg::clone( cube.get() ) ;
        osg::ref_ptr<ood::RigidBody> down_right = osg::clone( cube.get() ) ;
        ...
        osg::ref_ptr<ood::Joint> hinge = new ood::HingeJoint() ;

        hinge->setAxis1( osg::Y_AXIS ) ;


        ood::Joint*  hinge_left = osg::clone( hinge.get() ) ;
        ood::Joint*  hinge_right = osg::clone( hinge.get() ) ;
...
Scene::mainloop(void)
{
    ...
    oodUtil::ControllerBase* controller = new oodUtil::ControllerBase() ;
