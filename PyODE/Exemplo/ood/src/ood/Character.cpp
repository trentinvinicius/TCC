                 ...
                 )
{
    ...
    if( ! body ) {
        PS_WARN("ood::Character::attach(%p): null body", this) ;
        return NULL ;
    }


    PS_DBG("ood::Character::attach(%p, body=%p)", this, body) ;
...
{
    if( ! body ) {
        PS_WARN("ood::Character::detach(%p): null body", this) ;
        return ;
    }


    PS_DBG("ood::Character::detach(%p, body=%p)", this, body) ;
...
Character::touch( ooReal max_distance )
{
    ...
    if( NULL == body ) {
        PS_WARN("ood::Character::touch(%p): no rigid body", this) ;
        return NULL ;
    }
