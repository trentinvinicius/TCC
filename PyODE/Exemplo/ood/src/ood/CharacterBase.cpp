 ...
 */
/***************************************************************************
 *   Copyright (C) 2013 - 2017 by Rocco Martino                            *
    ...
    m_motion_fmax_mult      ( 1.0 )
{
    ...
    if( getObjectList().size() == 3 ) {
        ...
        PS_ASSERT1( dynamic_cast<RigidBody*>(getObject(0)) ) ;

        PS_ASSERT1( dynamic_cast<AMotorJoint*>(getObject(1)) ) ;

        PS_ASSERT1( dynamic_cast<LMotorJoint*>(getObject(2)) ) ;


        m_body = static_cast<RigidBody*>( getObject(0) ) ;
        m_amotor = static_cast<AMotorJoint*>( getObject(1) ) ;
        m_lmotor = static_cast<LMotorJoint*>( getObject(2) ) ;
    }
}
/* ....................................................................... */
/* ======================================================================= */
...
CharacterBase::update(ooReal step_size)
{
    ...
    if( m_body.valid() ) {
        ...
        setMatrix( m_body->getMatrix(), false ) ;

        osg::BoundingSphere bs = getActorBound() ;

        bs.center() = m_body->getActorBound().center() ;
...
#if 1
        const ood::CollisionParameters*  cp = collidable->getCollisionParameters() ;
...
//         PS_DBG3("ood::CharacterBase::_collideAgainstGround(%p): generating contact", this) ;
...
//
//         mt->setAutoRotateMode( osg::AutoTransform::ROTATE_TO_AXIS ) ;
//
//         mt->setAxis( osg::Z_AXIS ) ;
//
//         mt->addChild( m_body->getOrCreateDebugNode() ) ;
//
//         m_body->setDebugNode( mt ) ;
//     }
...

    {
        ...
        m_amotor->setAxis1Anchor( ood::AMotorJoint::BODY1 ) ;
        m_amotor->setAxis2Anchor( ood::AMotorJoint::BODY1 ) ;
        m_amotor->setAxis3Anchor( ood::AMotorJoint::BODY1 ) ;
...

    {
        ...
        m_lmotor->setAxis1Anchor( ood::LMotorJoint::WORLD ) ;
        m_lmotor->setAxis2Anchor( ood::LMotorJoint::WORLD ) ;
        m_lmotor->setAxis3Anchor( ood::LMotorJoint::WORLD ) ;
