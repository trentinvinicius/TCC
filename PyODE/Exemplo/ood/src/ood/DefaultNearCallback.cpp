...
{
    PS_DBG2("ood::DefaultNearCallback::allocateContactArray(%p, N=%u)", this, N) ;
...
{
    PS_DBG3("ood::DefaultNearCallback::reset(%p)", this) ;
...
{
//     PS_DBG3("ood::DefaultNearCallback::collide(%p, op=%p)", this, op) ;
...
DefaultNearCallback::addContact(dBodyID body1, dBodyID body2, dContact* contact)
{
    ...
    {
        case 0:
            PS_DBG3( "ood::DefaultNearCallback::addContact(%p): body1 == body2 == NULL, skipping contact", this) ;
            return ;
...
DefaultNearCallback::generateContacts(OverlappingPair* op, CollisionParameters* collision_parameters)
{
    ...
    PS_DBG3("ood::DefaultNearCallback::generateContacts(%p, ...): %p <=> %p num contacts: %d", this, collidable1, collidable2, num_contacts) ;
...
{
//     PS_DBG3("ood::DefaultNearCallback::_mixCollisionParameters(%p, cp1=%p, cp2=%p)", this, cp1, cp2) ;
    ...
    result->setMu( cp1->getMu() * cp2->getMu() ) ;
