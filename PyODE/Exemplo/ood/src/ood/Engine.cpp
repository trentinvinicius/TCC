...
Engine::propagate( ooReal step_size, ooReal& vel_out, ooReal& fmax_out )
{
    ...
    if( m_gear_list.size() > 0 ) {
        ...
        setRatio( m_gear_list[m_current_gear] / m_final ) ;
        ...
        if( fabs(new_ratio) > EPSILON   &&   fabs(current_ratio) > EPSILON ) {
            ...
            setRatio( interpolated_ratio / m_final ) ;

        } else {

            setRatio( new_ratio / m_final ) ;
        }
#endif
    }
    ...
    return this->EngineBase::propagate( step_size, vel_out, fmax_out ) ;
}
/* ....................................................................... */
/* ======================================================================= */
