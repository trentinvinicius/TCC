...
{
    PS_DBG2("ood::Joint::addToWorldInternal(%p, world=%p)", this, world) ;
...
{
    PS_DBG2("ood::Joint::removeFromWorldInternal(%p, world=%p)", this, world) ;
...
Joint::finalize(void)
{
    PS_DBG2("ood::Joint::finalize(%p)", this) ;
...
/* ....................................................................... */
void
Joint::setBody1(ood::RigidBody* body)
{
    PS_DBG2("ood::Joint::setBody1(%p, body=%p)", this, body) ;
...
/* ....................................................................... */
void
Joint::setBody2(ood::RigidBody* body)
{
    PS_DBG2("ood::Joint::setBody2(%p, body=%p)", this, body) ;
...
/*    setParam( dParamLoVel##X            ,  0.0) ;*/ \
/*    setParam( dParamHiVel##X            ,  0.0 ) ;*/ \
...
/* ....................................................................... */
ooReal
Joint::getPosition( Axis a ) const
{
    PS_WARN("ood::Joint::getPosition(%p, ...): base class method", this ) ;
...
ooReal
Joint::getPositionRate( Axis a ) const
{
    PS_WARN("ood::Joint::getPositionRate(%p, ...): base class method", this ) ;
