...
Manager::~Manager(void)
{
    PS_DBG3("ood::Manager::~Manager(%p)", this) ;
}
/* ....................................................................... */
/* ======================================================================= */
...
{
    PS_DBG( "ood::Manager::setup(%p, accept_visitors=%d, step_size=%lf)",
            this, accept_visitors, step_size) ;

    setUpdateCallback( new ood::ManagerUpdateCallback() ) ;
...
Manager::frame(ooReal dt)
{
    ...
    PS_DBG3("ood::Manager::frame(%p, dt=%lf)", this, dt) ;
...
Manager::computeBound(void) const
{
    ...
    if( m_world.valid() ) {
        ...
        const ood::ObjectList&   objects = m_world->getObjectList() ;
