...
{
    PS_DBG2(    "ood::RigidBody::setMass(%p, mass=%f, size=[%f, %f, %f], class=%d)",
    ...
    switch(type_class)
    {
        ...
        default:
            PS_FATAL("ood::RigidBody::setMass(%p, ...): invalid type (%u)", this, type_class) ;
        break ;
    }
...
{
    PS_DBG2(    "ood::RigidBody::setDensity(%p, density=%f, size=[%f, %f, %f], class=%d)",
    ...
    switch(type_class)
    {
        ...
        default:
            PS_FATAL("ood::RigidBody::setDensity(%p, ...): invalid type (%u)", this, type_class) ;
        break ;
    }
...
/* ....................................................................... */
void
ood::RigidBody::addForce(const osg::Vec3& f, const osg::Vec3& p, bool fl, bool pl)
{
...
/* ....................................................................... */
void
ood::RigidBody::addTorque(const osg::Vec3& t, bool local)
{
    if( local ) {
...
{
    PS_DBG2("ood::RigidBody::addToWorldInternal(%p, world=%p)", this, world) ;
    ...
    if( dBodyGetWorld(m_ODE_body) != world->getODEWorld() ) {
        ...
        PS_DBG3("ood::RigidBody::addToWorldInternal(%p): ODE body: %p", this, m_ODE_body) ;
...
{
    PS_DBG2("ood::RigidBody::removeFromWorldInternal(%p, world=%p)", this, world) ;
    ...
    PS_WARN("ood::RigidBody::removeFromWorldInternal(%p): world != getWorld()", this) ;
...
/* ....................................................................... */
void
RigidBody::criticalSection(void)
{
...
{
    PS_DBG2("ood::RigidBody::_cloneODEBody(src=%p, dest=%p)", src, dst) ;
