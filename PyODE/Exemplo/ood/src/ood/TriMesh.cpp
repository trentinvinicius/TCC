...
{
    PS_DBG2("ood::TriMesh::setMass(%p, mass=%f)", this, mass) ;
...
//     this->RigidBody::setKinematic(kinematic_flag) ;
    ...
    this->ood::RigidBody::setMass(mass, getSize(), dBoxClass) ;
}
/* ....................................................................... */
/* ======================================================================= */
...
{
    PS_DBG2("ood::TriMesh::setDensity(%p, density=%f)", this, density) ;
...
{
    PS_DBG2("ood::TriMesh::build(%p)", this) ;


    if( ! m_vertex_array.valid() ) {
        PS_FATAL("ood::TriMesh::build(%p): m_vertex_array == NULL", this) ;
        return false ;
    }
    ...
    if( ! m_index_array.valid() ) {
        PS_WARN("ood::TriMesh::build(%p): m_index_array == NULL, building now assuming array of triangles", this) ;
