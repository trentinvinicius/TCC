...
{
    PS_DBG2("ood::UniversalJoint::cloneODEJoint(%p, world=%p)", this, world) ;
...

    {
        ...
        dJointSetUniversalAutoComputeRelativeValues( j,      dJointGetUniversalAutoComputeRelativeValues(m_ODE_joint) ) ;

        dJointGetUniversalRelativeRotation1( m_ODE_joint, qrel ) ;

        dJointSetUniversalRelativeRotation1( j, qrel ) ;

        dJointGetUniversalRelativeRotation2( m_ODE_joint, qrel ) ;

        dJointSetUniversalRelativeRotation2( j, qrel ) ;
    }
...
/* ....................................................................... */
ooReal
UniversalJoint::getPosition( Axis a ) const
{
    switch( a )
    {
        case AXIS1:    return getAngle1() ;    break ;

        case AXIS2:    return getAngle2() ;    break ;
...
ooReal
UniversalJoint::getPositionRate( Axis a ) const
{
    switch( a )
    {
