...
World::threadStep(ooReal step_size)
{
    ...
    PS_DBG3("ood::World::threadStep(%p, step_size=%lf)", this, step_size) ;
    ...
    PS_DBG3("ood::World::threadStep(%p, step_size=%lf): calling WorldStep", this, step_size) ;
    {
    ...
    PS_DBG3("ood::World::threadStep(%p): calling post callbacks", this) ;
