...
#if 0
namespace {
static bool checkRows(const ood::BypassJoint& j)
{
    (void) j ;
    return true ;
}

static bool writeRows(osgDB::OutputStream& os, const ood::BypassJoint& j)
{
...
static bool readRows(osgDB::InputStream& is, ood::BypassJoint& j)
{
    osg::Vec3   J1a, J1l, J2a, J2l ;
    ooReal      rhs, cfm ;
...
static bool checkInfo(const ood::BypassJoint& j)
{
    (void) j ;
    return true ;
}

static bool writeInfo(osgDB::OutputStream& os, const ood::BypassJoint& j)
{
...
static bool readInfo(osgDB::InputStream& is, ood::BypassJoint& j)
{
    unsigned int    max_m, m, nub ;
...
REGISTER_OBJECT_WRAPPER( BypassJoint,
                         new ood::BypassJoint,
                         ood::BypassJoint,
                         "osg::Object ood::ODEObject ood::Transformable ood::Joint ood::BypassJoint" )
{
#if 0
