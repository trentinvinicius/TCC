...
namespace {
static bool
checkGeometrySize(const ood::Collidable& collidable)
{
...
static bool
readGeometrySize(osgDB::InputStream& is, ood::Collidable& collidable)
{
    osg::Vec3   size ;
...
static bool
writeGeometrySize(osgDB::OutputStream& os, const ood::Collidable& collidable)
{
    const osg::Vec3 size = collidable.getSize() ;
...
REGISTER_OBJECT_WRAPPER( Collidable,
                         /*new ood::Collidable*/ NULL,
                         ood::Collidable,
                         "osg::Object ood::ODEObject ood::Transformable ood::RigidBody ood::Collidable" )
{
    ...
    ADD_OBJECT_SERIALIZER( CollisionParameters, ood::CollisionParameters, NULL ) ;
    ADD_OBJECT_SERIALIZER( CollisionCallback, ood::CollisionCallback, NULL ) ;
