...
/* ======================================================================= */
/* ....................................................................... */
struct AddTorqueMethod: public osgDB::MethodObject
{
    virtual bool run(void* objectPtr, osg::Parameters& inputParameters, osg::Parameters& outputParameters) const
    {
        ...
        ood::RigidBody*     body = reinterpret_cast<ood::RigidBody*>( objectPtr ) ;

        int  x = dynamic_cast<osg::DoubleValueObject*>(inputParameters[0].get())->getValue() ;
        int  y = dynamic_cast<osg::DoubleValueObject*>(inputParameters[1].get())->getValue() ;
        int  z = dynamic_cast<osg::DoubleValueObject*>(inputParameters[2].get())->getValue() ;

        body->addTorque( osg::Vec3( x, y, z ) ) ;
...
struct AddForceMethod: public osgDB::MethodObject
{
    virtual bool run(void* objectPtr, osg::Parameters& inputParameters, osg::Parameters& outputParameters) const
    {
...
struct SetAxisAngleMethod: public osgDB::MethodObject
{
    virtual bool run(void* objectPtr, osg::Parameters& inputParameters, osg::Parameters& outputParameters) const
    {
        ...
        osg::Vec3   axis = dynamic_cast<osg::Vec3dValueObject*>(inputParameters[0].get())->getValue() ;
        float       angle = dynamic_cast<osg::DoubleValueObject*>(inputParameters[1].get())->getValue() ;


        osg::Quat   q = osg::Quat( osg::inDegrees(angle), axis ) ;
...
static bool check##V3_PROP(const ood::RigidBody& body) { return body.get##V3_PROP() != DEF ; } \
static bool read##V3_PROP(osgDB::InputStream& is, ood::RigidBody& body) \
{ \
    osg::Vec3   v ; \
    is >> v ; \
    body.set##V3_PROP(v) ; \
...
static bool write##V3_PROP(osgDB::OutputStream& os, const ood::RigidBody& body) \
{ \
...
static bool check##QUAT_PROP(const ood::RigidBody& body) { return body.get##QUAT_PROP() != DEF ; } \
static bool read##QUAT_PROP(osgDB::InputStream& is, ood::RigidBody& body) \
{ \
    osg::Quat   q ; \
    is >> q ; \
...
static bool write##QUAT_PROP(osgDB::OutputStream& os, const ood::RigidBody& body) \
{ \
...
static bool checkODEMass(const ood::RigidBody& body)
{
	(void) body ;
...
static bool readODEMass(osgDB::InputStream& is, ood::RigidBody& body)
{
    dMass   mass ;
...
static bool writeODEMass(osgDB::OutputStream& os, const ood::RigidBody& body)
{
...
REGISTER_OBJECT_WRAPPER( RigidBody,
                         new ood::RigidBody,
                         ood::RigidBody,
                         "osg::Object ood::ODEObject ood::Transformable ood::RigidBody" )
{
    ...
    ADD_METHOD_OBJECT( "addForce",      AddForceMethod      ) ;
    ADD_METHOD_OBJECT( "addTorque",     AddTorqueMethod     ) ;
    ADD_METHOD_OBJECT( "setAxisAngle",  SetAxisAngleMethod  ) ;
}
/* ....................................................................... */
/* ======================================================================= */
