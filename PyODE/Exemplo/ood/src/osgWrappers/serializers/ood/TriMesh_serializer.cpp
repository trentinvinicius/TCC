...
/* ....................................................................... */
namespace {
static bool checkVertexArray(const ood::TriMesh& trimesh)
{
    return trimesh.getVertexArray() != NULL ;
}

static bool writeVertexArray(osgDB::OutputStream& os, const ood::TriMesh& trimesh)
{
...
static bool readVertexArray(osgDB::InputStream& is, ood::TriMesh& trimesh)
{
    unsigned int    size = 0 ;
...
static bool checkIndexArray(const ood::TriMesh& trimesh)
{
    return trimesh.getIndexArray() != NULL ;
}

static bool writeIndexArray(osgDB::OutputStream& os, const ood::TriMesh& trimesh)
{
...
static bool readIndexArray(osgDB::InputStream& is, ood::TriMesh& trimesh)
{
    unsigned int    size = 0 ;
...
REGISTER_OBJECT_WRAPPER( TriMesh,
                         new ood::TriMesh,
                         ood::TriMesh,
                         "osg::Object ood::ODEObject ood::Transformable ood::RigidBody ood::Collidable ood::TriMesh" )
{
    ...
    struct BuildTriMesh: public osgDB::FinishedObjectReadCallback
    {
        ...
        {
            (void) is ;
            static_cast<ood::TriMesh*>(&obj)->build() ;
        }
    } ;
