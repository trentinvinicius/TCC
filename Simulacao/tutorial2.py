...
while loopFlag:
    ...
    pygame.draw.line(srf, (55,0,200), coord(0,2), coord(int(x1),int(y1)), 2)
    pygame.draw.circle(srf, (55,0,200), coord(int(x2),int(y2)), 20, 0)
    pygame.draw.line(srf, (55,0,200), coord(int(x1),int(y1)), coord(int(x2),int(y2)), 2)
