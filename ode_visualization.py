...
class ODE_Visualization(VTK_Visualization):
    ...
    def drawLines(self, points, lineWidth = 1.5, lineColor = (1, 1, 1)):       
        for p in points:
    ...
    def getScreenshot(self, name):
        ...
        writer.SetFileName("/home/vinicius/Dropbox/TCCViniciusTrentin/Screenshot/"+name+".png")
